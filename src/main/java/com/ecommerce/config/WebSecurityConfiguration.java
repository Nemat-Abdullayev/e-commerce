...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers(HttpMethod.POST,"/e-commerce/api/v1/user").permitAll()
                .antMatchers(HttpMethod.POST,"/e-commerce/api/v1/auth/**").permitAll()
                .antMatchers(HttpMethod.POST,"/e-commerce/api/v1/user/logout/all").permitAll()
